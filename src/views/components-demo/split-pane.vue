<template>
  <div class="components-container">
    ...
    <!--min-percent,max-percent,default-percent 是paneL的占比 -->
    <split-pane :min-percent="20" :default-percent="33" split="vertical" @resize="resize">
      <template slot="paneL">
...
<script>
// splitPane垂直水平分割窗口的一个插件，很简单的一个东西
